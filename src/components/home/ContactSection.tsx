    ...
    <section className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-14">
          <p className="text-gold-600 text-sm uppercase tracking-[0.2em] font-medium mb-3">Get in Touch</p>
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-navy-900 mb-4">Contact Us</h2>
          <p className="text-navy-600 max-w-xl mx-auto">Ready to find your dream property? Reach out to our team and we will respond within 24 hours.</p>
        </AnimatedSection>
